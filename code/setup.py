...
PLANET_DATA = {
    (360, 273): ("Dips in Light", "Exoplanet HAT-P-7b", "AAAAAAAAAAAAAAAAAAAAAAA"),
    (382, 295): ("Dips in Light", 'Exoplanet Kepler-1625b', "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"),
    (371, 420): ("Reading the Wobble", "Exoplanet HD-209458b", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"),
    (1018, 107): ("Dips in Light","Exoplanet K2-18b", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"),
    (396, 517): ("Dips in Light","Exoplanet TRAPPIST-1b", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"),
}
